    ...
    <div className="md:w-full flex justify-between ">
      ...
      <div className="flex gap-6">
        <input
          ...
          className="md:w-[260px] md:h-[56px] text-[16px] text-black/70 font-semibold border border-gray-400 px-8 py-2 outline-none rounded"
        />
      ...
      {/* total section */}
      <div className="md:w-[470px] md:h-[324px] border-2 border-black/60 flex flex-col gap-5 justify-center px-6 rounded">
        <h2 className="text-[20px] text-black/80 font-semibold ">Cart Total</h2>
        {/* subtotal */}
