...
const HeroNewArrival = () => {
  return (
    <section className=" relative w-full flex flex-col justify-between gap-16 md:mt-16">
      <HeroHeadLine thumb={"Featured"} title={"New Arrival"} />
      {/* grid items */}
      <div className='w-full flex justify-center'>
        <div className=' md:w-[85%] grid grid-cols-4 grid-flow-col grid-rows-2 space-y-8'>
