      ...
      <form action={action} className="w-full md:flex justify-between items-start">
        ...
        <div className="w-full md:w-[550px] flex flex-col gap-6 ">
            ...
            <div key={item.id} className=" flex items-center justify-between">
              <div className="flex items-center gap-1 md:gap-3">
                <Image
                  ...
                  height={70}
                />
                <h3 className="text-[12px] md:text-sm text-black/80">{item?.title}</h3>
              </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-[12px] md:text-sm text-black/80">Cash on Delivery</h3>
          </div>
          ...
          <div className="flex justify-between md:justify-start md:gap-6">
            ...
            />
            <Link href='/cart' className="w-32 h-8 md:w-[218px] md:h-[56px] flex items-center justify-center rounded text-[12px] md:text-[16px] font-semibold bg-[#DB4444] hover:bg-[#DB2222] text-white ">
              Apply Coupon
            </Link>
          </div>
          {/* order button */}
          <button type="submit"  disabled={ispending}  className="w-full h-8 md:w-[200px] md:h-12 text-white text-[12px] md:text-[16px] font-semibold bg-[#DB4444] hover:bg-[#DB2222] rounded flex items-center justify-center ">
            Place Order
          </button>
