...
const handleAllDelete = () => {
  ...
  return (
    <section className="container mx-auto px-2 md:px-14 pb-10 md:py-20 bg-white">
      ...
      <button onClick={handleAllDelete} className="w-20 md:w-[200px] md:h-12 text-[12px] md:text-[16px] font-semibold hover:text-white flex items-center justify-center border border-gray-300 hover:bg-[#DB4444] rounded cursor-pointer">Clear All</button>
      </div>
