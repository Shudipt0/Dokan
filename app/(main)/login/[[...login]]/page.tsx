      ...
      <div className="w-full md:flex items-center justify-center gap-30">
        ...
        <div className="w-full md:w-[370px] ">
          <SignIn.Root>
            ...
            >
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between">
                  <SignIn.Action
                    submit
                    className="w-[145px] h-8 md:h-14 flex items-center justify-center text-sm md:text-[16px] text-white bg-[#DB4444] hover:bg-[#DB5555] cursor-pointer rounded "
                  >
                    Continue
                  </SignIn.Action>
                </div>
              ...
              <div className="w-full flex items-center justify-center gap-3">
                <p className="text-sm md:text-[16px] text-gray-600 ">Didn't have account?</p>
                <Link
                  href="login"
            ...
            <SignIn.Step name="verifications">
              <SignIn.Strategy name="password">
                <div className="flex flex-col gap-6">
                  <h1 className="text-[18px] md:text-2xl text-black/80 font-semibold">
                    Enter your password
                  </h1>
                  ...
                  <Clerk.Field name="password" className="w-full ">
                    <Clerk.Label className="flex items-center relative">
                      <Clerk.Input
                        type="password"
                        className="outline-none peer text-sm md:text-[18px] text-black/80 font-semibold duration-200 "
                      />
                      <span className="absolute left-0 text-sm md:text-[18px] text-gray-400 peer-focus:text-sm peer-focus:-translate-y-5 duration-200 peer-user-valid:-translate-y-5 peer-valid:text-sm peer-valid:bg-white">
                        Password
                      </span>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <SignIn.Action
                      ...
                      className="text-sm md:text-[16px] text-[#DB4444]"
                    >
                      Forgot password?
                    </SignIn.Action>
                  </div>
              ...
              <SignIn.Strategy name="reset_password_email_code">
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-sm md:text-[16px] text-black/80 font-semibold flex items-center gap-2 ">
                    We sent a code to{" "}
                  ...
                  <Clerk.Field name="code" className="w-full ">
                    <Clerk.Label className="flex items-center relative">
                      <Clerk.Input
                        type="code"
                        className="outline-none peer text-sm md:text-[20px] text-black/80 font-semibold duration-200 "
                      />
                      <span className="absolute left-0 text-sm md:text-[20px] text-gray-400 peer-focus:text-sm peer-focus:-translate-y-5 duration-200 peer-user-valid:-translate-y-5 peer-valid:text-sm peer-valid:bg-white">
                        Code
                      </span>
                    </Clerk.Label>
                    <div className="w-full h-[1.5px] my-1 bg-gray-300 "></div>
                  ...
                  <SignIn.Action
                    submit
                    className="w-28 h-8 md:w-[145px] md:h-14 flex items-center justify-center text-[12px] md:text-[16px] text-white bg-[#DB4444] hover:bg-[#DB5555] cursor-pointer rounded "
                  >
                    Continue
                  </SignIn.Action>
                </div>
            ...
            <SignIn.Step name="forgot-password" className="space-y-3 md:space-y-6">
              <h1 className="text-[18px] md:text-2xl text-black/80 font-semibold">
                Forgot your password?
              </h1>

              <SignIn.SupportedStrategy name="reset_password_email_code">
                <div className="w-28 h-8 md:w-[145px] md:h-14 flex items-center justify-center text-sm md:text-[16px] text-white bg-gray-500 hover:bg-gray-600 cursor-pointer rounded ">
                  Reset password
                </div>
            ...
            <SignIn.Step name="reset-password" className="space-y-3 md:space-y-6">
              <h1 className="text-[18px] md:text-2xl text-black/80 font-semibold">
                Reset your password
              </h1>
